...
class RequestDecoratorSpec extends ObjectBehavior
{
    ...
    {
        $this->beAnInstanceOf('spec\Http\Message\RequestDecoratorStub', [$request]);
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('spec\Http\Message\RequestDecoratorStub');
    }
    ...
    {
        $this->shouldUseTrait('Http\Message\RequestDecorator');
    }
