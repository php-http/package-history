...
namespace spec\Http\Cookie\CookieJar;

use Http\Cookie\Cookie;
use Http\Cookie\CookieJar;
use Http\Cookie\CookieJar\CookieJarTemplate;
...
class CookieJarTemplateSpec extends ObjectBehavior
{
    function let()
    {
        $this->beAnInstanceOf('spec\Http\Cookie\CookieJar\DummyCookieJar');
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('spec\Http\Cookie\CookieJar\DummyCookieJar');
    }

    function it_is_a_cookie_jar()
    {
        $this->shouldImplement('Http\Cookie\CookieJar');
    }
    ...
    function it_returns_all_cookies()
    {
        ...
        $this->getCookies()->shouldBeAnArrayOfInstance('Http\Cookie\Cookie');
    }
    ...
    function it_returns_the_matching_cookies()
    {
        ...
        $this->getMatchingCookies($cookie2)->shouldBeAnArrayOfInstance('Http\Cookie\Cookie');
    }
