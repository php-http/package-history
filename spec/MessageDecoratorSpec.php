...
use Http\Message\MessageDecorator;
...
class MessageDecoratorSpec extends ObjectBehavior
{
    ...
    {
        $this->beAnInstanceOf('spec\Http\Message\MessageDecoratorStub', [$message]);
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('spec\Http\Message\MessageDecoratorStub');
    }
    ...
    {
        $this->shouldUseTrait('Http\Message\MessageDecorator');
    }
